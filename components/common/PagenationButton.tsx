...
function PagenationButton() {
  return (
    <div className="flex">
      <button className="w-40pxr h-40pxr flex-center rounded-t rounded-l border border-gray30">
        <Image src={arrowLeftIcon} alt="왼쪽화살표 아이콘" />
      </button>
      <button className="w-40pxr h-40pxr flex-center rounded-r rounded-b border border-gray30">
